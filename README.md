...
| ---: | --- | --- | --- |
| 8706 | [Patroni](https://github.com/zalando/patroni) | Template for PostgreSQL HA with ZooKeeper or etcd. | 2026-09-03 |
...
| 4371 | [autobase](https://github.com/vitabaks/autobase) | Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters. | 2026-09-05 |
...
| 1385 | [pg_auto_failover](https://github.com/citusdata/pg_auto_failover) | Postgres extension and service for automated failover and high-availability. | 2026-08-03 |
| 746 | [Spock](https://github.com/pgEdge/spock) | 100% open-source logical multi-master PostgreSQL replication. | 2026-09-03 |
...
| 81 | [pg-status](https://github.com/krylosov-aa/pg-status) | A microservice that provides HTTP endpoints for instantly retrieving the current master host or a replica that meets various criteria. | 2026-09-05 |
...
| 404 | [Dekart](https://github.com/dekart-xyz/dekart) | Open-source platform to turn PostGIS queries into shareable interactive maps. | 2026-09-05 |
...
| 8700 | [atlas](https://github.com/ariga/atlas) | Atlas is a tool for managing and migrating database schemas using modern DevOps principles. | 2026-09-04 |
...
| 295 | [sabiql](https://github.com/riii111/sabiql) | A fast, driver-less TUI to browse, query, and edit PostgreSQL databases. | 2026-09-05 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 1387 | [Apache Cloudberry](https://github.com/apache/cloudberry) | And MPP PostgreSQL fork. Open source alternative to Greenplum Database. | 2026-09-03 |
...
| 26 | [pgrls](https://github.com/pgrls/pgrls) | static analyzer for row-level security policies; 36 rules across security, performance, and hygiene with 10 mechanically auto-fixable; includes a semantic policy-diff command for CI gating. | 2026-09-05 |
...
| 3607 | [postgres_exporter](https://github.com/wrouesnel/postgres_exporter) | Prometheus exporter for PostgreSQL server metrics. | 2026-09-01 |
...
| 185 | [check_pgactivity](https://github.com/OPMDG/check_pgactivity) | check_pgactivity is designed to monitor PostgreSQL clusters from Nagios. It offers many options to measure and monitor useful performance metrics. | 2026-09-05 |
...
| 7 | [pgwd](https://github.com/hrodrig/pgwd) | monitors PostgreSQL connection usage and stale sessions, with threshold alerts, Prometheus metrics, and multiple notification backends. | 2026-09-05 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 12748 | [Citus](https://github.com/citusdata/citus) | Scalable PostgreSQL cluster for real-time workloads. | 2026-09-04 |
| 9232 | [ParadeDB](https://github.com/paradedb/paradedb) | Postgres for Search and Analytics | 2026-09-05 |
| 9232 | [pg_search](https://github.com/paradedb/paradedb) | pg_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search. | 2026-09-05 |
| 4799 | [AGE](https://github.com/apache/age) | Adds fully-functional graph database support including Cypher queries. | 2026-08-26 |
...
| 2811 | [pg_partman](https://github.com/pgpartman/pg_partman) | Partition management extension for PostgreSQL. | 2026-08-21 |
| 1783 | [cstore_fdw](https://github.com/citusdata/cstore_fdw) | Columnar store for analytics with PostgreSQL. | 2021-03-08 |
| 1704 | [HypoPG](https://github.com/HypoPG/hypopg) | HypoPG provides hypothetical/virtual indexes feature. | 2026-09-05 |
...
| 779 | [plpgsql_check](https://github.com/okbob/plpgsql_check) | Extension that allows to check plpgsql source code. | 2026-09-05 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 5642 | [river](https://github.com/riverqueue/river) | A high-performance job processing system for Go and Postgres. | 2026-08-31 |
| 5205 | [pgmq](https://github.com/pgmq/pgmq) | A lightweight message queue. Like AWS SQS and RSMQ but on Postgres. | 2026-09-05 |
| 3930 | [pgBoss](https://github.com/timgit/pg-boss) | Queueing jobs in Postgres from Node.js like a boss. | 2026-09-05 |
...
| 3585 | [PEV2](https://github.com/dalibo/pev2) | Online Postgres Explain Visualizer. | 2026-08-28 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 32113 | [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) | Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events. | 2026-08-19 |
...
| 12931 | [PostGraphile](https://github.com/graphile/postgraphile) | Instant GraphQL API or GraphQL schema for your PostgreSQL database | 2026-09-04 |
| 6570 | [pgroll](https://github.com/xataio/pgroll) | Zero-downtime, reversible, schema migrations for Postgres | 2026-05-27 |
| 6519 | [pgloader](https://github.com/dimitri/pgloader) | Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data. | 2026-07-24 |
...
| 1396 | [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | Advanced job scheduler for PostgreSQL. | 2026-08-31 |
...
| 35 | [Qail](https://github.com/qail-io/qail) | rust-first typed AST pipeline for PostgreSQL with compile-time query checks and built-in tenant scoping. | 2026-09-05 |
...
| 9956 | [pq](https://github.com/lib/pq) |  | 2026-08-20 |
...
| 1216 | [postgrex](https://github.com/elixir-ecto/postgrex) |  | 2026-09-03 |
| 871 | [pg](https://github.com/ged/ruby-pg) |  | 2026-09-03 |
| 592 | [pg.zig](https://github.com/karlseguin/pg.zig) |  | 2026-08-26 |
| 431 | [Postmodern](https://github.com/marijnh/Postmodern) |  | 2025-07-24 |
| 343 | [RPostgres](https://github.com/r-dbi/RPostgres) |  | 2026-09-05 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 9246 | [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) | A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments. | 2026-09-04 |
| 5232 | [Zalando Operator](https://github.com/zalando/postgres-operator) | Creates and manages PostgreSQL clusters running in Kubernetes. | 2026-09-03 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 1218 | [pg-utils](https://github.com/dataegret/pg-utils) | Useful DBA tools by Data Egret | 2026-06-29 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 8570 | [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) |  | 2026-09-05 |
