...
| ---: | --- | --- | --- |
| 8635 | [Patroni](https://github.com/zalando/patroni) | Template for PostgreSQL HA with ZooKeeper or etcd. | 2026-07-24 |
...
| 4317 | [autobase](https://github.com/vitabaks/autobase) | Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters. | 2026-07-30 |
...
| 1366 | [pg_auto_failover](https://github.com/citusdata/pg_auto_failover) | Postgres extension and service for automated failover and high-availability. | 2026-07-30 |
| 741 | [Spock](https://github.com/pgEdge/spock) | 100% open-source logical multi-master PostgreSQL replication. | 2026-07-29 |
...
| 181 | [pgrwl](https://github.com/hashmap-kz/pgrwl) | Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg_receivewal. | 2026-07-30 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 4200 | [wal-g](https://github.com/wal-g/wal-g) | The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases. | 2026-07-30 |
...
| 2610 | [pgbackweb](https://github.com/eduardolat/pgbackweb) | A Complete Docker-based Postgres backup and maintenance tool with Web UI. | 2025-11-21 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 28720 | [Redash](https://github.com/getredash/redash) | Connect to any data source, easily visualize and share your data. | 2026-07-09 |
| 21584 | [Teable](https://github.com/teableio/teable) | A Super fast, Real-time, Professional, Developer friendly, No code database. | 2026-07-29 |
| 9458 | [pgweb](https://github.com/sosedoff/pgweb) | Web-based PostgreSQL database browser written in Go. | 2026-07-03 |
...
| 766 | [temBoard](https://github.com/dalibo/temboard) | Web-based PostgreSQL GUI and monitoring. | 2026-07-30 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 5250 | [Pigsty](https://github.com/Vonng/pigsty) | Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers. | 2026-07-30 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 13320 | [pgcli](https://github.com/dbcli/pgcli) | Postgres CLI with autocompletion and syntax highlighting | 2026-07-24 |
| 8618 | [atlas](https://github.com/ariga/atlas) | Atlas is a tool for managing and migrating database schemas using modern DevOps principles. | 2026-07-29 |
| 3688 | [schemaspy](https://github.com/schemaspy/schemaspy) | SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams | 2026-03-05 |
| 867 | [pg-schema-diff](https://github.com/stripe/pg-schema-diff) | CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking. | 2026-07-28 |
| 604 | [pgsh](https://github.com/sastraxi/pgsh) | Branch your PostgreSQL Database like Git | 2022-03-13 |
| 260 | [squix](https://github.com/eduardofuncao/squix) | SQL command-line client with query management and interactive results. | 2026-07-20 |
| 243 | [sabiql](https://github.com/riii111/sabiql) | A fast, driver-less TUI to browse, query, and edit PostgreSQL databases. | 2026-07-26 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 1250 | [Apache Cloudberry](https://github.com/apache/cloudberry) | And MPP PostgreSQL fork. Open source alternative to Greenplum Database. | 2026-07-30 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 1486 | [Acra](https://github.com/cossacklabs/acra) | SQL database security suite: proxy for data protection with transparent "on the fly" data encryption, SQL firewall (SQL injections prevention), intrusion detection system. | 2025-12-05 |

## Monitoring

| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 7852 | [coroot](https://github.com/coroot/coroot) | Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance. | 2026-07-27 |
| 3581 | [postgres_exporter](https://github.com/wrouesnel/postgres_exporter) | Prometheus exporter for PostgreSQL server metrics. | 2026-07-26 |
| 2089 | [dexter](https://github.com/ankane/dexter) | The automatic indexer for Postgres. Detects slow queries and creates indexes if configured to do so. | 2026-07-30 |
...
| 1079 | [PMM](https://github.com/percona/pmm) | Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB. | 2026-07-30 |
...
| 601 | [Check_postgres](https://github.com/bucardo/check_postgres) | Nagios check_postgres plugin for checking status of PostgreSQL databases. | 2025-01-02 |
...
| 356 | [pg_exporter](https://github.com/Vonng/pg_exporter) | Fully customizable Prometheus exporter for PostgreSQL & Pgbouncer with fine-grained execution control. | 2026-07-29 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 12649 | [Citus](https://github.com/citusdata/citus) | Scalable PostgreSQL cluster for real-time workloads. | 2026-07-28 |
| 9111 | [ParadeDB](https://github.com/paradedb/paradedb) | Postgres for Search and Analytics | 2026-07-30 |
| 9111 | [pg_search](https://github.com/paradedb/paradedb) | pg_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search. | 2026-07-30 |
...
| 4712 | [AGE](https://github.com/apache/age) | Adds fully-functional graph database support including Cypher queries. | 2026-07-17 |
| 3854 | [pg_cron](https://github.com/citusdata/pg_cron) | Run periodic jobs in PostgreSQL. | 2026-07-21 |
| 2780 | [pg_partman](https://github.com/pgpartman/pg_partman) | Partition management extension for PostgreSQL. | 2026-07-26 |
| 1783 | [cstore_fdw](https://github.com/citusdata/cstore_fdw) | Columnar store for analytics with PostgreSQL. | 2021-03-08 |
| 1687 | [HypoPG](https://github.com/HypoPG/hypopg) | HypoPG provides hypothetical/virtual indexes feature. | 2026-06-19 |
| 1416 | [pgRouting](https://github.com/pgRouting/pgrouting) | pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality. | 2026-07-28 |
| 1231 | [pglogical](https://github.com/2ndQuadrant/pglogical) | Extension that provides logical streaming replication. | 2026-07-28 |
| 1062 | [pg_shard](https://github.com/citusdata/pg_shard) | Extension to scale out real-time reads and writes. | 2016-08-03 |
| 771 | [plpgsql_check](https://github.com/okbob/plpgsql_check) | Extension that allows to check plpgsql source code. | 2026-07-29 |
| 686 | [pg_squeeze](https://github.com/cybertec-postgresql/pg_squeeze) | An extension for automatic bloat cleanup with minimal locking. | 2026-07-29 |
| 586 | [pg_stat_monitor](https://github.com/percona/pg_stat_monitor) | Query Performance Monitoring tool for PostgreSQL. | 2026-07-30 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 5494 | [river](https://github.com/riverqueue/river) | A high-performance job processing system for Go and Postgres. | 2026-07-29 |
| 5043 | [pgmq](https://github.com/pgmq/pgmq) | A lightweight message queue. Like AWS SQS and RSMQ but on Postgres. | 2026-07-30 |
| 3812 | [pgBoss](https://github.com/timgit/pg-boss) | Queueing jobs in Postgres from Node.js like a boss. | 2026-07-29 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 8902 | [PgHero](https://github.com/ankane/pghero) | PostgreSQL insights made easy. | 2026-07-30 |
| 3517 | [PEV2](https://github.com/dalibo/pev2) | Online Postgres Explain Visualizer. | 2026-07-28 |
| 2731 | [pgtune](https://github.com/le0pard/pgtune) | Online version of PostgreSQL configuration wizard. | 2026-07-29 |
...
| 498 | [aqo](https://github.com/postgrespro/aqo) | Adaptive query optimization for PostgreSQL. | 2025-03-17 |
...
| 39 | [pgassistant](https://github.com/beh74/pgassistant-community) | A PostgreSQL tool for developers to help understand, optimize database with LLM and pgTune integration. | 2026-07-28 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 32060 | [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) | Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events. | 2026-07-28 |
| 27485 | [PostgREST](https://github.com/PostgREST/postgrest) | Serves a fully RESTful API from any existing PostgreSQL database. | 2026-07-30 |
| 12934 | [PostGraphile](https://github.com/graphile/postgraphile) | Instant GraphQL API or GraphQL schema for your PostgreSQL database | 2026-07-30 |
| 6542 | [pgroll](https://github.com/xataio/pgroll) | Zero-downtime, reversible, schema migrations for Postgres | 2026-05-27 |
| 6486 | [pgloader](https://github.com/dimitri/pgloader) | Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data. | 2026-07-24 |
| 4605 | [pREST](https://github.com/prest/prest) | Serve a RESTful API from any PostgreSQL database (Golang) | 2026-07-30 |
...
| 3145 | [sqitch](https://github.com/sqitchers/sqitch) | Tool for managing versioned schema deployment | 2026-07-13 |
...
| 1730 | [Greenmask](https://github.com/GreenmaskIO/greenmask) | Database anonymization and synthetic data generation tool for MySQL and PostgreSQL. | 2026-07-01 |
| 1620 | [pgCenter](https://github.com/lesovsky/pgcenter) | Provides convenient interface to various statistics, management task, reloading services, viewing log files and canceling or terminating database backends. | 2026-07-27 |
...
| 1389 | [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | Advanced job scheduler for PostgreSQL. | 2026-07-29 |
...
| 287 | [GatewayD](https://github.com/gatewayd-io/gatewayd) | Cloud-native database gateway and framework for building data-driven applications. Like API gateways, for databases. | 2026-02-22 |
...
| 9911 | [pq](https://github.com/lib/pq) |  | 2026-07-27 |
| 3976 | [rust-postgresql](https://github.com/sfackler/rust-postgres) |  | 2026-07-27 |
| 3717 | [Npgsql](https://github.com/npgsql/npgsql) |  | 2026-07-23 |
| 1402 | [zapatos](https://github.com/jawj/zapatos) |  | 2025-09-19 |
| 1213 | [postgrex](https://github.com/elixir-ecto/postgrex) |  | 2026-07-28 |
| 870 | [pg](https://github.com/ged/ruby-pg) |  | 2026-07-27 |
| 585 | [pg.zig](https://github.com/karlseguin/pg.zig) |  | 2026-07-22 |
| 431 | [Postmodern](https://github.com/marijnh/Postmodern) |  | 2025-07-24 |
| 339 | [RPostgres](https://github.com/r-dbi/RPostgres) |  | 2026-07-28 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 9058 | [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) | A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments. | 2026-07-30 |
| 5213 | [Zalando Operator](https://github.com/zalando/postgres-operator) | Creates and manages PostgreSQL clusters running in Kubernetes. | 2026-07-30 |
| 4437 | [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) | Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service. | 2026-06-02 |
| 1420 | [StackGres Operator](https://github.com/ongres/stackgres/) | Full Stack PostgreSQL on Kubernetes. | 2026-07-22 |
...
| 382 | [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) | Percona Operator for PostgreSQL based on Crunchy Data operator. | 2026-07-29 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 1216 | [pg-utils](https://github.com/dataegret/pg-utils) | Useful DBA tools by Data Egret | 2026-06-29 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 8532 | [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) |  | 2026-07-30 |
