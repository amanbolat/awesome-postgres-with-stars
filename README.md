...
| ---: | --- | --- | --- |
| 8442 | [Patroni](https://github.com/zalando/patroni) | Template for PostgreSQL HA with ZooKeeper or etcd. | 2026-05-20 |
...
| 4212 | [autobase](https://github.com/vitabaks/autobase) | Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters. | 2026-05-21 |
...
| 171 | [pgrwl](https://github.com/hashmap-kz/pgrwl) | Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg_receivewal. | 2026-05-21 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 4092 | [wal-g](https://github.com/wal-g/wal-g) | The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases. | 2026-05-20 |
...
| 2582 | [pgbackweb](https://github.com/eduardolat/pgbackweb) | A Complete Docker-based Postgres backup and maintenance tool with Web UI. | 2025-11-21 |
...
| 21250 | [Teable](https://github.com/teableio/teable) | A Super fast, Real-time, Professional, Developer friendly, No code database. | 2026-05-14 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 5131 | [Pigsty](https://github.com/Vonng/pigsty) | Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers. | 2026-05-11 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 13180 | [pgcli](https://github.com/dbcli/pgcli) | Postgres CLI with autocompletion and syntax highlighting | 2026-05-12 |
| 8409 | [atlas](https://github.com/ariga/atlas) | Atlas is a tool for managing and migrating database schemas using modern DevOps principles. | 2026-05-21 |
| 3614 | [schemaspy](https://github.com/schemaspy/schemaspy) | SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams | 2026-03-05 |
| 850 | [pg-schema-diff](https://github.com/stripe/pg-schema-diff) | CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking. | 2026-01-07 |
| 601 | [pgsh](https://github.com/sastraxi/pgsh) | Branch your PostgreSQL Database like Git | 2022-03-13 |
| 237 | [squix](https://github.com/eduardofuncao/squix) | SQL command-line client with query management and interactive results. | 2026-05-07 |
...
| 1022 | [PMM](https://github.com/percona/pmm) | Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB. | 2026-05-21 |
...
| 181 | [check_pgactivity](https://github.com/OPMDG/check_pgactivity) | check_pgactivity is designed to monitor PostgreSQL clusters from Nagios. It offers many options to measure and monitor useful performance metrics. | 2026-05-19 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 12504 | [Citus](https://github.com/citusdata/citus) | Scalable PostgreSQL cluster for real-time workloads. | 2026-05-20 |
| 8804 | [ParadeDB](https://github.com/paradedb/paradedb) | Postgres for Search and Analytics | 2026-05-21 |
| 8804 | [pg_search](https://github.com/paradedb/paradedb) | pg_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search. | 2026-05-21 |
...
| 3784 | [pg_cron](https://github.com/citusdata/pg_cron) | Run periodic jobs in PostgreSQL. | 2026-04-21 |
| 2711 | [pg_partman](https://github.com/pgpartman/pg_partman) | Partition management extension for PostgreSQL. | 2026-03-05 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 5140 | [river](https://github.com/riverqueue/river) | A high-performance job processing system for Go and Postgres. | 2026-05-15 |
| 4878 | [pgmq](https://github.com/pgmq/pgmq) | A lightweight message queue. Like AWS SQS and RSMQ but on Postgres. | 2026-05-20 |
| 3546 | [pgBoss](https://github.com/timgit/pg-boss) | Queueing jobs in Postgres from Node.js like a boss. | 2026-05-02 |
...
| 3472 | [PEV2](https://github.com/dalibo/pev2) | Online Postgres Explain Visualizer. | 2026-05-07 |
| 2710 | [pgtune](https://github.com/le0pard/pgtune) | Online version of PostgreSQL configuration wizard. | 2026-05-11 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 31966 | [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) | Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events. | 2026-05-19 |
| 27147 | [PostgREST](https://github.com/PostgREST/postgrest) | Serves a fully RESTful API from any existing PostgreSQL database. | 2026-05-21 |
...
| 6469 | [pgroll](https://github.com/xataio/pgroll) | Zero-downtime, reversible, schema migrations for Postgres | 2026-05-12 |
| 6425 | [pgloader](https://github.com/dimitri/pgloader) | Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data. | 2025-06-04 |
| 4551 | [pREST](https://github.com/prest/prest) | Serve a RESTful API from any PostgreSQL database (Golang) | 2026-04-30 |
| 4017 | [pgbadger](https://github.com/darold/pgbadger) | Fast PostgreSQL Log Analyzer. | 2026-04-10 |
| 3449 | [pgsync](https://github.com/ankane/pgsync) | Tool to sync PostgreSQL data to your local machine. | 2025-12-26 |
| 3128 | [sqitch](https://github.com/sqitchers/sqitch) | Tool for managing versioned schema deployment | 2026-01-25 |
...
| 1679 | [Greenmask](https://github.com/GreenmaskIO/greenmask) | Database anonymization and synthetic data generation tool for MySQL and PostgreSQL. | 2026-05-20 |
...
| 354 | [RegreSQL](https://github.com/dimitri/regresql) | Tool to build, maintain and execute a regression testing suite for SQL queries. | 2026-05-21 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 13136 | [node-postgres](https://github.com/brianc/node-postgres) |  | 2026-05-18 |
| 9891 | [pq](https://github.com/lib/pq) |  | 2026-04-08 |
| 3937 | [rust-postgresql](https://github.com/sfackler/rust-postgres) |  | 2026-04-04 |
| 3689 | [Npgsql](https://github.com/npgsql/npgsql) |  | 2026-05-19 |
...
| 549 | [pg.zig](https://github.com/karlseguin/pg.zig) |  | 2026-04-25 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 8651 | [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) | A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments. | 2026-05-21 |
...
| 4405 | [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) | Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service. | 2026-05-14 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 1207 | [pg-utils](https://github.com/dataegret/pg-utils) | Useful DBA tools by Data Egret | 2025-12-05 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 8493 | [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) |  | 2026-05-21 |
