...
| ---: | --- | --- | --- |
| 8330 | [Patroni](https://github.com/zalando/patroni) | Template for PostgreSQL HA with ZooKeeper or etcd. | 2026-04-08 |
...
| 4112 | [autobase](https://github.com/vitabaks/autobase) | Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters. | 2026-04-10 |
...
| 694 | [Spock](https://github.com/pgEdge/spock) | 100% open-source logical multi-master PostgreSQL replication. | 2026-04-10 |
...
| 90 | [pgrwl](https://github.com/hashmap-kz/pgrwl) | Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg_receivewal. | 2026-04-10 |
...
| 2545 | [pgbackweb](https://github.com/eduardolat/pgbackweb) | A Complete Docker-based Postgres backup and maintenance tool with Web UI. | 2025-11-21 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 28330 | [Redash](https://github.com/getredash/redash) | Connect to any data source, easily visualize and share your data. | 2026-04-01 |
| 21099 | [Teable](https://github.com/teableio/teable) | A Super fast, Real-time, Professional, Developer friendly, No code database. | 2026-04-01 |
| 9294 | [pgweb](https://github.com/sosedoff/pgweb) | Web-based PostgreSQL database browser written in Go. | 2026-03-01 |
| 1623 | [Postbird](https://github.com/Paxa/postbird) | PostgreSQL Client for macOS. | 2025-06-30 |
| 1001 | [PgManage](https://github.com/commandprompt/pgmanage) | A modern multi-platform Postgres-centric database client/administration tool. | 2026-01-14 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 4972 | [Pigsty](https://github.com/Vonng/pigsty) | Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers. | 2026-03-23 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 13097 | [pgcli](https://github.com/dbcli/pgcli) | Postgres CLI with autocompletion and syntax highlighting | 2026-04-01 |
| 8264 | [atlas](https://github.com/ariga/atlas) | Atlas is a tool for managing and migrating database schemas using modern DevOps principles. | 2026-04-10 |
...
| 830 | [pg-schema-diff](https://github.com/stripe/pg-schema-diff) | CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking. | 2026-01-07 |
...
| 159 | [sabiql](https://github.com/riii111/sabiql) | A fast, driver-less TUI to browse, query, and edit PostgreSQL databases. | 2026-04-10 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 1200 | [Apache Cloudberry](https://github.com/apache/cloudberry) | And MPP PostgreSQL fork. Open source alternative to Greenplum Database. | 2026-04-10 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 7557 | [coroot](https://github.com/coroot/coroot) | Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance. | 2026-04-10 |
...
| 1001 | [PMM](https://github.com/percona/pmm) | Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB. | 2026-04-10 |
...
| 8643 | [ParadeDB](https://github.com/paradedb/paradedb) | Postgres for Search and Analytics | 2026-04-10 |
| 8643 | [pg_search](https://github.com/paradedb/paradedb) | pg_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search. | 2026-04-10 |
...
| 4393 | [AGE](https://github.com/apache/age) | Adds fully-functional graph database support including Cypher queries. | 2026-04-06 |
| 3737 | [pg_cron](https://github.com/citusdata/pg_cron) | Run periodic jobs in PostgreSQL. | 2026-04-07 |
...
| 570 | [pg_stat_monitor](https://github.com/percona/pg_stat_monitor) | Query Performance Monitoring tool for PostgreSQL. | 2026-04-09 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 5004 | [river](https://github.com/riverqueue/river) | A high-performance job processing system for Go and Postgres. | 2026-04-09 |
| 4753 | [pgmq](https://github.com/pgmq/pgmq) | A lightweight message queue. Like AWS SQS and RSMQ but on Postgres. | 2026-04-09 |
| 3371 | [pgBoss](https://github.com/timgit/pg-boss) | Queueing jobs in Postgres from Node.js like a boss. | 2026-04-10 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 8827 | [PgHero](https://github.com/ankane/pghero) | PostgreSQL insights made easy. | 2026-04-04 |
| 3448 | [PEV2](https://github.com/dalibo/pev2) | Online Postgres Explain Visualizer. | 2026-04-07 |
| 2692 | [pgtune](https://github.com/le0pard/pgtune) | Online version of PostgreSQL configuration wizard. | 2026-04-08 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 31937 | [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) | Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events. | 2026-04-08 |
| 26845 | [PostgREST](https://github.com/PostgREST/postgrest) | Serves a fully RESTful API from any existing PostgreSQL database. | 2026-04-10 |
| 12911 | [PostGraphile](https://github.com/graphile/postgraphile) | Instant GraphQL API or GraphQL schema for your PostgreSQL database | 2026-04-10 |
| 6416 | [pgroll](https://github.com/xataio/pgroll) | Zero-downtime, reversible, schema migrations for Postgres | 2026-02-16 |
| 6379 | [pgloader](https://github.com/dimitri/pgloader) | Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data. | 2025-06-04 |
| 4540 | [pREST](https://github.com/prest/prest) | Serve a RESTful API from any PostgreSQL database (Golang) | 2026-03-07 |
| 3990 | [pgbadger](https://github.com/darold/pgbadger) | Fast PostgreSQL Log Analyzer. | 2026-04-10 |
...
| 1345 | [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | Advanced job scheduler for PostgreSQL. | 2026-04-10 |
...
| 106 | [diesel-guard](https://github.com/ayarotsky/diesel-guard) | Linter for dangerous Postgres migration patterns in Diesel and SQLx. | 2026-04-08 |
...
| 47 | [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) | The NServiceBus.Transport.PostgreSql library allows .NET developers to use a PostgreSQL database as a message broker. (Commerical Software) | 2026-04-10 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 13111 | [node-postgres](https://github.com/brianc/node-postgres) |  | 2026-03-07 |
| 9849 | [pq](https://github.com/lib/pq) |  | 2026-04-08 |
| 3924 | [rust-postgresql](https://github.com/sfackler/rust-postgres) |  | 2026-04-04 |
| 3672 | [Npgsql](https://github.com/npgsql/npgsql) |  | 2026-04-10 |
...
| 522 | [pg.zig](https://github.com/karlseguin/pg.zig) |  | 2026-02-18 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 8395 | [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) | A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments. | 2026-04-02 |
| 5139 | [Zalando Operator](https://github.com/zalando/postgres-operator) | Creates and manages PostgreSQL clusters running in Kubernetes. | 2026-04-07 |
...
| 360 | [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) | Percona Operator for PostgreSQL based on Crunchy Data operator. | 2026-04-10 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 8463 | [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) |  | 2026-04-10 |
