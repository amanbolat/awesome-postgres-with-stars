...
| ---: | --- | --- | --- |
| 8436 | [Patroni](https://github.com/zalando/patroni) | Template for PostgreSQL HA with ZooKeeper or etcd. | 2026-05-16 |
...
| 4203 | [autobase](https://github.com/vitabaks/autobase) | Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters. | 2026-05-17 |
...
| 723 | [Spock](https://github.com/pgEdge/spock) | 100% open-source logical multi-master PostgreSQL replication. | 2026-05-19 |
...
| 166 | [pgrwl](https://github.com/hashmap-kz/pgrwl) | Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg_receivewal. | 2026-05-19 |
| 71 | [pg-status](https://github.com/krylosov-aa/pg-status) | A microservice that provides HTTP endpoints for instantly retrieving the current master host or a replica that meets various criteria. | 2026-05-19 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 28581 | [Redash](https://github.com/getredash/redash) | Connect to any data source, easily visualize and share your data. | 2026-05-06 |
| 21251 | [Teable](https://github.com/teableio/teable) | A Super fast, Real-time, Professional, Developer friendly, No code database. | 2026-05-14 |
| 9357 | [pgweb](https://github.com/sosedoff/pgweb) | Web-based PostgreSQL database browser written in Go. | 2026-04-26 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 5126 | [Pigsty](https://github.com/Vonng/pigsty) | Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers. | 2026-05-11 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 13179 | [pgcli](https://github.com/dbcli/pgcli) | Postgres CLI with autocompletion and syntax highlighting | 2026-05-12 |
...
| 3585 | [schemaspy](https://github.com/schemaspy/schemaspy) | SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams | 2026-03-05 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 7648 | [coroot](https://github.com/coroot/coroot) | Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance. | 2026-05-19 |
| 3519 | [postgres_exporter](https://github.com/wrouesnel/postgres_exporter) | Prometheus exporter for PostgreSQL server metrics. | 2026-05-17 |
...
| 1022 | [PMM](https://github.com/percona/pmm) | Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB. | 2026-05-19 |
...
| 348 | [pg_exporter](https://github.com/Vonng/pg_exporter) | Fully customizable Prometheus exporter for PostgreSQL & Pgbouncer with fine-grained execution control. | 2026-04-14 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 12500 | [Citus](https://github.com/citusdata/citus) | Scalable PostgreSQL cluster for real-time workloads. | 2026-05-15 |
| 8786 | [ParadeDB](https://github.com/paradedb/paradedb) | Postgres for Search and Analytics | 2026-05-19 |
| 8786 | [pg_search](https://github.com/paradedb/paradedb) | pg_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search. | 2026-05-19 |
...
| 4530 | [AGE](https://github.com/apache/age) | Adds fully-functional graph database support including Cypher queries. | 2026-05-14 |
| 3782 | [pg_cron](https://github.com/citusdata/pg_cron) | Run periodic jobs in PostgreSQL. | 2026-04-21 |
...
| 1646 | [HypoPG](https://github.com/HypoPG/hypopg) | HypoPG provides hypothetical/virtual indexes feature. | 2026-04-18 |
| 1396 | [pgRouting](https://github.com/pgRouting/pgrouting) | pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality. | 2026-05-05 |
...
| 754 | [plpgsql_check](https://github.com/okbob/plpgsql_check) | Extension that allows to check plpgsql source code. | 2026-05-14 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 5133 | [river](https://github.com/riverqueue/river) | A high-performance job processing system for Go and Postgres. | 2026-05-15 |
| 4870 | [pgmq](https://github.com/pgmq/pgmq) | A lightweight message queue. Like AWS SQS and RSMQ but on Postgres. | 2026-05-19 |
| 3540 | [pgBoss](https://github.com/timgit/pg-boss) | Queueing jobs in Postgres from Node.js like a boss. | 2026-05-02 |
...
| 2707 | [pgtune](https://github.com/le0pard/pgtune) | Online version of PostgreSQL configuration wizard. | 2026-05-11 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 31967 | [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) | Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events. | 2026-05-19 |
| 27137 | [PostgREST](https://github.com/PostgREST/postgrest) | Serves a fully RESTful API from any existing PostgreSQL database. | 2026-05-19 |
...
| 6468 | [pgroll](https://github.com/xataio/pgroll) | Zero-downtime, reversible, schema migrations for Postgres | 2026-05-12 |
...
| 4016 | [pgbadger](https://github.com/darold/pgbadger) | Fast PostgreSQL Log Analyzer. | 2026-04-10 |
...
| 3012 | [pg_activity](https://github.com/dalibo/pg_activity) | top like application for PostgreSQL server activity monitoring. | 2026-05-18 |
...
| 1413 | [ERAlchemy](https://github.com/Alexis-benoist/eralchemy) | ERAlchemy generates Entity Relation (ER) diagram from databases. | 2026-05-05 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 13133 | [node-postgres](https://github.com/brianc/node-postgres) |  | 2026-05-18 |
| 9889 | [pq](https://github.com/lib/pq) |  | 2026-04-08 |
| 3937 | [rust-postgresql](https://github.com/sfackler/rust-postgres) |  | 2026-04-04 |
| 3686 | [Npgsql](https://github.com/npgsql/npgsql) |  | 2026-05-19 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 8636 | [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) | A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments. | 2026-05-19 |
| 5164 | [Zalando Operator](https://github.com/zalando/postgres-operator) | Creates and manages PostgreSQL clusters running in Kubernetes. | 2026-05-11 |
| 4406 | [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) | Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service. | 2026-05-14 |
...
| 368 | [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) | Percona Operator for PostgreSQL based on Crunchy Data operator. | 2026-05-19 |
...
| Stars | Name | Description | Last Commit |
| ---: | --- | --- | --- |
| 8492 | [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) |  | 2026-05-19 |
